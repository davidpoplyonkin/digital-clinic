...
urlpatterns = [
    ...
    path(
        "htmx/paneltest/<int:test_pk>/append/",
        views.paneltest_append,
        name="paneltest-append",
    ),
    path(
        "htmx/paneltest/<str:prefix>/delete/",
        views.paneltest_delete,
        name="paneltest-delete",
    ),
]
