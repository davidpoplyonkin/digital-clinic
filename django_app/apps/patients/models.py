...
class Patient(models.Model):
    ...
    gender = models.CharField(
        choices=[("male", "Male"), ("female", "Female")], verbose_name="gender"
    )
    dob = models.DateField(verbose_name="date of birth")
    height = models.DecimalField(
        max_digits=5, decimal_places=2, blank=True, null=True, verbose_name="height (m)"
    )
    ...
    phone1 = models.CharField(max_length=20, blank=True, verbose_name="phone 1")
