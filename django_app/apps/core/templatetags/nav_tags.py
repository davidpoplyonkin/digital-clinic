...
nav_pills = {
    "Patients": {
        ...
        "apps": {
            "patients": {"name": "Patients", "link": "patients:patient-list"},
        },
    },
    "Lab": {
        ...
        "apps": {
            "lab": {"name": "Lab", "link": "lab:lab-list"},
            "panels": {"name": "Panels", "link": "panels:panel-list"},
            "tests": {"name": "Tests", "link": "tests:test-list"},
        },
    },
    "MC Reports": {
        ...
        "apps": {
            "mc_reports": {"name": "MC Reports", "link": "mc_reports:mcr-list"},
        },
    },
    "X-Rays": {
        "url_main": "x_rays:x-rays-list",
        "bootstrap_icon": "bi-radioactive",
        "apps": {"x_rays": {"name": "X-Rays", "link": "x_rays:x-rays-list"}},
    },
    "Colonoscopy": {
